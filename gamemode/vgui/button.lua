...
function cButton:Init()
	self.InteractColor = Color(155, 155, 155, 255)
...
function cButton:Paint()
	...
	draw.SimpleText(self.Text, self.Font, self:GetWide()/2, self:GetTall()/2-1,color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
end
