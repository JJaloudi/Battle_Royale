...
PERK.ID = 5 // ID of the perk HAS TO BE UNIQUE. 

PERK.Name = "Jumpman" //Name of the perk
PERK.Desc = "You're a track star! Your jump power is increased by 20%." //Description of the perk
...
PERK.Icon = Material("perks/jumpman.png") // Icon for the perk.
PERK.Color = Color(195, 195, 195) // Color of the background.
...
PERK.DoPerk = function(pl, gametype)
	pl:SetJumpPower(pl:GetJumpPower() + (pl:GetJumpPower() * .20))
end
